...
export class AuthController {
    ...
    async login(
        ...
        const current = await this.rawCacheService.get<number>(rateLimitKey);
        ...
        await this.rawCacheService.set(rateLimitKey, (current || 0) + 1, RATE_LIMIT_WINDOW);
    ...
    @Endpoint({
        ...
        httpCode: HttpStatus.OK,
        apiBody: RefreshTokenRequestDto,
    })
